...
--vaadake tabelit 2 ja kustutage isiku ID 8
select * from Person
go
...
--valib inimese või linnu ümardatud vanus numbri või vanuse järgi
select * from Person order by cast(Age as int)
select * from Person order by Age

--valida sumirunoi vanuse järgi
...
--Sisesta nimi näiteks Tom ja see kuvatakse tabelis
declare @FirstName nvarchar(50)
execute spGetNameById1 6, @FirstName output
print 'Name of the employee = ' + @FirstName

--Töötaja number küsib tema nime
...
-- Kirjutame nime ja saame tema isikut tõendava dokumendi
